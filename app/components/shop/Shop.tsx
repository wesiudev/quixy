...
export default function Shop({
  ...
  return (
    ...
    >
      <div className="w-full text-center text-2xl md:text-3xl lg:text-4xl lg:w-max mx-auto lg:mx-0 italic bg-white text-black p-4 px-8 lg:rounded-lg font-coco font-bold my-12 shadow-md shadow-zinc-700">
      ...
      <div className="group text-white font-bold text-2xl flex flex-row items-center hover:text-green-400 duration-150 w-max">
