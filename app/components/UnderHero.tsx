...
export default function UnderHero() {
  return (
    <div className="min-h-screen w-screen bg-green-500 flex flex-col xl:flex-row xl:pl-[8vw]">
      <div className=" rounded-lg w-[90vw] xl:w-1/2 h-max  bg-white relative mt-24 mx-auto">
        ...
        <div className="w-full  text-md lg:text-lg bg-white rounded-b-lg lg:rounded-tl-lg rounded-bl-lg p-3 font-coco selection:bg-green-400 selection:text-white">
      ...
      <div className="w-[90vw] mx-auto xl:w-1/2 xl:pl-24 bg-gradient-to-r from-green-500 via-yellow-200 to-green-500 rounded-3xl lg:p-24  pt-12 pb-36 ">
        <Image
          src={websites}
          width={1200}
          height={1200}
