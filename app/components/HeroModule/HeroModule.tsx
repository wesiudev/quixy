  ...
  return (
    <>
      <div className="h-[35vh] lg:h-[35vh] duration-1000 w-screen flex items-center overflow-hidden top-[50%] -translate-y-[50%] absolute flex-col lg:flex-row bg-gradient-to-b from-green-500  to-blue-500">
        {/* first plane image */}
        <div className="absolute h-screen -left-[12vw] xl:-left-[5vw] w-auto overflow-hidden top-[50%] -translate-y-[50%] z-10 object-cover">
          <Image
            src="/assets/bg.webp"
        ...
        <div className="hidden lg:block absolute -right-[12vw] 2xl:-right-[3vw] h-screen w-auto overflow-hidden top-[50%] -translate-y-[50%] z-[5] object-cover">
          <Image
            src="/assets/bg2.webp"
            alt="Hero Image Tworzenie stron internetowych Quixy.pl"
            fill
      ...
      <div className="w-screen h-screen mt-0 bg-zinc-900 bg-opacity-75">
        {/* second plane image */}
        <div className="absolute h-screen w-auto overflow-hidden -left-[12vw] xl:-left-[5vw] top-[50%] -translate-y-[50%] -z-[5] opacity-100 object-cover blur-md">
          <Image
            src="/assets/bg.webp"
            alt="Hero Image Tworzenie stron internetowych Quixy.pl"
            fill
        ...
        <div className="hidden lg:block absolute h-screen w-auto overflow-hidden top-[50%] -translate-y-[50%] -right-[12vw] 2xl:-right-[3vw] -z-10 opacity-100 object-cover blur-md">
          <Image
            src="/assets/bg2.webp"
            alt="Hero Image Tworzenie stron internetowych Quixy.pl"
            fill
