        ...
        <div className="min-h-screen w-full pt-24 px-3 lg:px-[8vw] mx-auto bg-gradient-to-b bg-green-400 relative overflow-hidden">
          ...
          <div className=" flex flex-col w-full mx-auto mt-24">
            <div className="py-12 font-bold relative flex flex-col lg:flex-row">
                    ...
                    {!page.isGraphic && (
                      <div className="grid grid-cols-1 space-y-6 pr-12 mt-6">
                        <div className="relative flex flex-row items-start">
                          <div className="text-3xl text-white opacity-50">
                            1.
                          </div>
              ...
              <div className="w-full lg:w-2/5 items-end justify-end flex flex-col lg:items-start lg:justify-start relative overflow-hidden h-max">
                <div className="bg-gradient-to-r from-green-400 via-yellow-300 to-green-400 rounded-t-full pb-12 lg:block hidden">
                  <Image
                    src={ninja}
                    width={1024}
                    height={1024}
                ...
                <div className="w-full p-3 xl:p-6  rounded-xl bg-white flex justify-between items-center font-coco mt-12 lg:mt-0">
                  <div className="flex flex-col w-full ">
                    <div className="flex flex-row items-center justify-between w-full">
                      <div className="flex flex-col">
                        <span className="w-max text-black pr-6 text-xl font-bold">
                          {page.name}
                        </span>
                        <span className="w-max text-black italic text-lg">
                          od {page.price}
                        </span>
                      </div>
                      <Link
                        href={`/zamow-strone-internetowa/`}
                        className="relative overflow-hidden w-max text-center text-black font-light text-xl bg-yellow-300 hover:shadow-md hover:shadow-black duration-150 hover:bg-green-500 hover:text-white rounded-md lg:p-3 p-5 shadow-md shadow-green-700"
                      >
                        <div className="absolute -left-4 -top-4 h-8 w-8 rounded-full bg-yellow-300"></div>
                        <div className="absolute -right-4 -bottom-4 h-8 w-8 rounded-full bg-yellow-300"></div>
                        <div className="absolute -right-4 -top-3 h-6 w-6 rounded-full bg-yellow-300"></div>
                        <div className="absolute -left-4 -bottom-3 h-6 w-6 rounded-full bg-yellow-300"></div>
                        <span className="relative z-50">
                          {" "}
                          {!page.isGraphic ? "ZAMÓW STRONĘ" : "ZAMÓW GRAFIKĘ"}
                        </span>
                      </Link>
                    </div>
                    <div className="h-max mt-6 flex flex-col">
                      <h1 className="text-black text-xl mb-6 font-bold">
                      ...
                      <div className="flex flex-col ">
                        {page.description.infos?.map((info, i) => (
                          <div
                            key={i}
                            className="flex flex-row items-center hover:bg-green-200 p-2"
                          >
                            <FaCheck className="text-green-500 rounded-3xl text-2xl" />
                            <div className="text-left text-black select-none ml-2 font-light text-xl">
                              {" "}
                              {info}
                            </div>
                          </div>
                ...
                <div className="w-full overflow-visible mt-12 aspect-square hidden lg:flex items-center justify-center ">
                  <Image
                    src={superhero}
                    width={1024}
                    height={1024}
