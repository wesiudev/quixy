...
export default function NewPost() {
  ...
  return (
    <div className="relative">
      {messageVisible && (
        <div
          className={`bg-green-500 text-white text-3xl w-max h-max p-12 fixed left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] flex items-center justify-center`}
        >
        ...
        <div className="flex flex-col ">
          ...
          <div className="grid grid-cols-1 bg-white text-black text-lg h-max">
            <div className="p-6 flex flex-row items-center bg-blue-500">
              <h1 className="border-r-2 border-white h-full p-6 text-white w-1/4">
                TYTUŁ POSTA
              </h1>
              <input
                value={input.title}
            ...
            <div className="p-6 flex flex-col items-center bg-orange-500">
          ...
          <div className="p-6 flex flex-row items-center bg-purple-500">
            <h1 className="border-r-2 border-white h-full p-6 text-white min-w-1/4">
              ZAKOŃCZENIE
            </h1>
            <input
              value={input.outro}
          ...
          {input.url !== "" && (
            <button
              onClick={() => {
                addBlogPost("quixy", input), setInput({ ...input, url: "" });
              }}
              className="py-6 bg-green-500 text-2xl text-white hover:bg-green-400 duration-200"
            >
              OPUBLIKUJ
